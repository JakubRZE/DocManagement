namespace DocManagement.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                {
                    ...
                    UploadDate = c.DateTime(defaultValueSql: "GETDATE()"),
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    RegistrationDate = c.DateTime(defaultValueSql: "GETDATE()"),
            ...
            CreateTable(
                ...
                {
                    Id = c.Int(nullable: false, identity: true),
                    DownloadDate = c.DateTime(defaultValueSql: "GETDATE()"),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Downloads", "ApplicationUserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Downloads", new[] { "ApplicationUserId" });
